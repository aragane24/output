      ...
      <TwoColumn>
        <TwoColumnMain>
          <PostBody>
            ...
            <p>
              制作時に意識した点として2つあります。まず、できるだけシンプルなデザインのサイトになるよう設計をした事です。余計な情報はなるべく省き、ユーザーが見たい情報、求めている情報だけを入れるようサイトの構成に工夫をしました。次に、レスポンシブ対応を行った事です。モバイルでもPC使用時と同じような使い勝手になるように、設計を決めて開発を行いました。
            </p>
            <h3>今後挑戦したいこと</h3>
            <p>
